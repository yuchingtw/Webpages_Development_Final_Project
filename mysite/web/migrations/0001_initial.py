# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-06-10 09:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uploder', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Video',
            fields=[
                ...
                ('video_length', models.DecimalField(decimal_places=0, max_digits=20)),
                ('publish_time', models.DateTimeField(auto_now_add=True)),
